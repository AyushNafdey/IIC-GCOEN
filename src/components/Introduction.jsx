...
const Hero = () => {
    return (
        <>
            <div className='w-full h-auto rounded-md px-6 lg:block md:hidden sm:hidden max-sm:hidden'>
                <img src={gcoen} />
            </div>

            <div className='lg:hidden px-5'>
                <img src={gcoen_mobile} className='md:w-full md:px-4 pb-5' />
                <div className='text-xl md:text-xl max-md:text-lg'>
            ...
            <div className='px-7 text-xl font-normal max-sm:text-lg max-md:text-xl md:text-xl sm:text-2xl pb-7'>
