...
function Focus_Function() {
  return (
    <>
      <div className="flex flex-col md:flex-row gap-x-8 w-full py-4 md:py-7 justify-center items-stretch">
        {/* Card 1 */}
        ...
        <div className="w-full max-w-[320px] h-[600px] md:h-auto mx-auto md:mx-0 md:w-[385px] rounded-3xl p-2 bg-gradient-to-l from-blue-700 via-red-600 to-yellow-500">
          <div className="h-full rounded-2xl bg-white overflow-hidden">
            ...
            <div className="px-4 md:px-7">
              ...
              <ul className="list-disc text-gray-700 space-y-1 md:space-y-2 pl-5 overflow-y-auto max-h-[340px] max-md:max-h-[300px] text-sm md:text-base">
